...
export const Requests_list = () =>{
    return(<div>
        <div className="container" style={{marginTop: "25px", width: "50%"}}>
            <AddingForm params={[    
                                 {type: 'multiple-select', title: 'items', servName: {servName: 'items', selectField: 'id_item', displayFields: ['name']}, servData: 'https://localhost:44354/api/teacher/get_all_items', counter: true, endRow: true}
