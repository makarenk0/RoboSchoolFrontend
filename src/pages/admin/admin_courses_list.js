    ...
    return(
      ...
      <div className="container" style={{marginTop: "25px", width: "50%"}}>
            <AddingForm params={[{type: 'text', title: 'course name', servName: 'name_course', servData: '',endRow: true},    
                                 {type: 'multiple-select', title: 'required item', servName: {servName: 'id_item', displayFields: ["name"]}, servData: 'https://localhost:44354/api/admin/get_all_items', counter: false, endRow: true}
