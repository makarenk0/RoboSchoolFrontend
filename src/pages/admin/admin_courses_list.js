    ...
    return(
      ...
      <div className="container" style={{marginTop: "25px", width: "50%"}}>
            <AddingForm params={[{type: 'text', title: 'course name', servName: 'name_course', servData: '',endRow: true},    
                                 {type: 'multiple-select', title: 'required item', servName: {servName: 'id_item', wrapName: 'items', displayNames: ["name"]}, servData: 'https://roboschool-api.herokuapp.com/api/admin/get_all_items', counter: false, endRow: true}
