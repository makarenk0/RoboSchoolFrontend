    ...
    return(
      ...
      <div className="container" style={{marginTop: "25px", width: "50%"}}>
            <AddingForm params={[{type: 'text', title: 'adress', servName: 'adress', servData: '',endRow: false}, 
                                  ...
                                  {type: 'select', title: 'teacher', servName: {servName: 'id_teacher', displayFields: ['name', 'surname', 'lastname']}, servData: 'https://roboschool-api.herokuapp.com/api/admin/get_all_free_teachers', endRow: true},
                                  {type: 'select', title: 'manager', servName: {servName: 'id_manager', displayFields: ['name', 'surname', 'lastname']}, servData: 'https://roboschool-api.herokuapp.com/api/admin/get_all_free_managers', endRow: true}
