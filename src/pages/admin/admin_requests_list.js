    ...
    return(
      <div>
        ...
        <AddingForm params={[]}></AddingForm>
            {
              <Table filterRequest="https://roboschool-api.herokuapp.com/api/admin/get_requests_with_adress" request={'https://roboschool-api.herokuapp.com/api/admin/get_all_requests'} onDelete={'https://roboschool-api.herokuapp.com/api/admin/delete_request/' }
