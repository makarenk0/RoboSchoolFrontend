    ...
    return(
      ...
      <div className="container" style={{marginTop: "25px", width: "50%"}}>
            <AddingForm params={[{type: 'text', title: 'provider name', servName: 'prov_name', servData: '',endRow: false}, 
                                  {type: 'text', title: 'contact number', servName: 'contact_number', servData: '', endRow: true},
                                ...
                                ]} submitRequest = 'https://roboschool-api.herokuapp.com/api/admin/add_provider'></AddingForm>
      </div>
        <div style={{marginTop: "50px"}}>
            {<Table request={'https://roboschool-api.herokuapp.com/api/admin/get_all_providers'} onDelete={'https://roboschool-api.herokuapp.com/api/admin/delete_provider/'}></Table>}
        </div>
      </div>
    )
}